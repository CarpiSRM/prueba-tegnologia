    ...
    <footer className="w-full bg-primary text-primary-foreground py-8">
      <div className="container px-4 md:px-6 flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="text-center md:text-right">
          <p className="text-sm text-primary-foreground/60">&copy; {new Date().getFullYear()} TecnologIA. Todos los derechos reservados.</p>
          <Link href="/contacto" className="text-sm text-accent hover:underline">
            Ponerse en contacto
          </Link>
        </div>
      </div>
